...
def get_text(lang):
    if lang == "ar":
        ...
        return {
            ...
            "tech": "Tech / IT", "engineering": "Engineering & Petroleum", "business": "Business & Management",
...
def main():
    ...
    with tab4:
        ...
        if st.session_state.pdf_bytes:
            ...
            st.download_button(label="📥 " + L["download_pdf"], data=st.session_state.pdf_bytes, file_name="optimized_resume.pdf", mime="application/pdf", use_container_width=True)
